...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log('Ensamblando un auto %cElectrico', COLORS.blue);
  }
...
class GasCar implements Vehicle {
  assemble(): void {
    console.log('Ensamblando un auto de %cCombustion', COLORS.brown);
  }
  // Implementación del método assemble
...
class ElectricEngine implements Engine {
  start(): void {
    console.log('Arrancando motor electrico');
  }
...
class GasEngine implements Engine {
  start(): void {
    console.log('Arrancando motor de combustion');
  }
  // Implementación del método start
